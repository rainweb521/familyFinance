/*
 ...
 Source Schema         : family_finance

 Target Server Type    : MySQL
 Target Server Version : 50723
 File Encoding         : 65001

 Date: 13/05/2020 17:11:17
*/
...
-- ----------------------------
-- Table structure for rc_bank
-- ----------------------------
DROP TABLE IF EXISTS `rc_bank`;
CREATE TABLE `rc_bank` (
  ...
  `sbalance` decimal(10,2) DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `rc_bank` VALUES (7, NULL, '123', '2020-03-08 18:20:55', '2020-03-08 18:20:55', 1000.00, '11', 1, NULL, '11', NULL, NULL, NULL, NULL);
INSERT INTO `rc_bank` VALUES (8, NULL, '建设银行', '2020-03-08 19:42:57', '2020-03-08 22:14:45', 100000.00, '买房', 1, NULL, '无', NULL, NULL, NULL, NULL);
INSERT INTO `rc_bank` VALUES (9, NULL, '中国银行', '2020-03-08 21:49:47', '2020-03-18 21:19:28', 20000.00, '房贷', 2, NULL, '无', '100', '1', 1000.00, '1000');
INSERT INTO `rc_bank` VALUES (10, NULL, 'gongs', '2020-03-18 21:15:34', '2020-03-18 21:15:34', 10000.00, 'ff', 1, NULL, '11', '1000', NULL, NULL, NULL);
COMMIT;
...
-- ----------------------------
-- Table structure for rc_broken
-- ----------------------------
DROP TABLE IF EXISTS `rc_broken`;
CREATE TABLE `rc_broken` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Table structure for rc_income
-- ----------------------------
DROP TABLE IF EXISTS `rc_income`;
CREATE TABLE `rc_income` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) DEFAULT NULL,
  `category` varchar(10) DEFAULT NULL COMMENT '支出为1，收入为2',
  `price` decimal(10,2) DEFAULT NULL,
  `status` int(10) DEFAULT NULL,
  `status_str` varchar(255) DEFAULT NULL,
...
-- ----------------------------
-- Records of rc_income
-- ----------------------------
BEGIN;
INSERT INTO `rc_income` VALUES (5, '香蕉', '香蕉', 100.00, 2, '', '2020-03-02 21:50:35', NULL, '无', 58, NULL);
INSERT INTO `rc_income` VALUES (6, '1', '1', 1.00, 2, '', '2020-03-02 21:59:26', NULL, '1', 50, NULL);
INSERT INTO `rc_income` VALUES (8, '奖金', '收入', 100.00, 1, '', '2020-03-08', NULL, '无', 0, '奖金啊');
INSERT INTO `rc_income` VALUES (9, '饮食', '支出', 1100.00, 1, '', '2020-03-08', NULL, '无', 0, '测试');
COMMIT;
...
INSERT INTO `rc_menu` VALUES ('1213374096520249344', 'courier', 'root', '000000000000000000', '收支信息管理', '/courier', 1, 1, 1, 1, 'fa  fa-jpy', '2020-01-04 16:18:23', '2020-03-08 20:24:12');
INSERT INTO `rc_menu` VALUES ('1213660774094864384', 'null', 'root', '000000000000000000', '理财计划管理', 'null', 1, 1, 2, 1, 'fa fa-money', '2020-01-05 11:17:32', '2020-03-08 20:26:02');
INSERT INTO `rc_menu` VALUES ('1213660987069038592', 'delivery', 'null', '1213660774094864384', '投资方案推荐', 'courier/deliverylist', 1, 2, 1, 1, 'fa fa-money', '2020-01-05 11:18:23', '2020-03-08 20:25:37');
INSERT INTO `rc_menu` VALUES ('1213661249364033536', 'car', 'root', '000000000000000000', '银行账户管理', 'car', 1, 1, 3, 1, 'fa fa-credit-card-alt', '2020-01-05 11:19:25', '2020-03-08 20:26:42');
INSERT INTO `rc_menu` VALUES ('1213661353022062592', 'carinfo', 'car', '1213661249364033536', '存款管理', 'car/list', 1, 2, 1, 1, 'fa fa-paypal', '2020-01-05 11:19:50', '2020-03-08 20:27:11');
INSERT INTO `rc_menu` VALUES ('1213661614847295488', 'charts', 'root', '000000000000000000', '统计分析管理', 'charts', 1, 1, 4, 1, 'fa fa-bar-chart', '2020-01-05 11:20:52', '2020-03-08 20:27:59');
INSERT INTO `rc_menu` VALUES ('1213662008562417664', 'charts_courier', 'charts', '1213661614847295488', '支出类别统计', 'charts/delivery', 1, 2, 1, 1, 'fa fa-bars', '2020-01-05 11:22:26', '2020-03-08 20:28:34');
INSERT INTO `rc_menu` VALUES ('1213662217036103680', 'revenus', 'charts', '1213661614847295488', '收支统计', 'charts/revenue', 1, 2, 1, 1, 'fa fa-bars', '2020-01-05 11:23:16', '2020-03-08 20:28:38');
INSERT INTO `rc_menu` VALUES ('1236582358073737216', '/courier/list2', 'courier', '1213374096520249344', '收入管理', '/courier/list2', 1, 2, 4, 1, 'fa fa-usd', '2020-03-08 17:19:43', '2020-03-08 20:25:09');
INSERT INTO `rc_menu` VALUES ('1236598206414979072', 'car/list2', 'car', '1213661249364033536', '贷款管理', 'car/list2', 1, 2, 2, 1, 'fa fa-google-wallet', '2020-03-08 18:22:42', '2020-03-08 20:27:37');
INSERT INTO `rc_menu` VALUES ('1236603227487600640', 'charts/delivery2', 'charts', '1213661614847295488', '收入类别统计', 'charts/delivery2', 1, 2, 2, 1, 'fa fa-bars', '2020-03-08 18:42:39', '2020-03-08 20:28:41');
INSERT INTO `rc_menu` VALUES ('893287144657780736', 'system', 'root', '000000000000000000', '用户权限管理', 'system', 1, 1, 10, 1, 'fa fa-cogs', '2017-08-04 09:47:06', '2020-03-08 19:18:52');
INSERT INTO `rc_menu` VALUES ('893288715881807872', 'userList', 'system', '893287144657780736', '用户管理', 'user/list', 1, 2, 1, 1, 'fa fa-user', '2017-08-04 09:53:21', '2020-03-08 20:32:06');
...
INSERT INTO `rc_menu` VALUES ('894475142061621248', 'roleList', 'system', '893287144657780736', '角色管理', 'role/list', 1, 2, 2, 1, 'fa fa-users', '2017-08-07 16:27:47', '2020-03-08 20:31:16');
...
INSERT INTO `rc_menu` VALUES ('894476950951690240', 'menu/list', 'system', '893287144657780736', '菜单管理', 'menu/list', 1, 2, 2, 1, 'fa fa-tasks', '2017-08-07 16:34:58', '2020-03-08 20:30:44');
...
INSERT INTO `rc_menu` VALUES ('894752734459199488', 'companyList', 'courier', '1213374096520249344', '支出管理', 'courier/list', 1, 2, 1, 1, 'fa fa-usd', '2017-08-08 10:50:50', '2020-03-08 20:25:03');
...
-- ----------------------------
-- Table structure for rc_money
-- ----------------------------
DROP TABLE IF EXISTS `rc_money`;
CREATE TABLE `rc_money` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL COMMENT '名称',
  `bank` varchar(255) DEFAULT NULL COMMENT '发行机构',
  `risk` varchar(255) DEFAULT NULL COMMENT '风险程度',
  `interest` varchar(255) DEFAULT NULL COMMENT '利率',
  `length` varchar(50) DEFAULT NULL COMMENT '产品期限',
  `content` varchar(255) DEFAULT NULL COMMENT '产品介绍',
  `start` varchar(255) DEFAULT NULL COMMENT '起购额度',
  `type` varchar(255) DEFAULT NULL COMMENT '产品类型',
  `buyinfo` varchar(255) DEFAULT NULL COMMENT '购买规则',
  `buyinfo2` varchar(255) DEFAULT NULL COMMENT '赎回规则',
  `buyinfo3` varchar(255) DEFAULT NULL COMMENT '收益规则',
...
-- ----------------------------
BEGIN;
INSERT INTO `rc_money` VALUES (1, '平安45天周期盈', '平安养老保险股份有限公司', '低风险', '3.6810%', '45天', '平安45天周期盈养老保险', '1000元起购', '养老保险', '随时可买，单笔不可超过20000元。下单后不可撤销。', '锁定起45天，锁定期间不可赎回，若要赎回需要提前预约。', '确认购买成功当天开始计算收益，于下一交易日推送。', '注意风险');
INSERT INTO `rc_money` VALUES (2, '京弘保险', '健康人寿保险股份有限公司', '中低风险', '5.68%', '3年', '由京弘保险推出的', '2000元起', '保险', '购买成功后扣除投保金额1%作为初始费用。', '转出后5天内到账。', '该产品工作日产生收益，购买后第二个工作日计算。', NULL);
INSERT INTO `rc_money` VALUES (3, '平安养老金通369天', '平安养老保险股份有限公司', '高风险', '4.68%', '369天', '由平安保险推出的高风险', '10000元起购', '养老', '随时可买，下单后不可取消。', '锁定期间为369天，不可提前赎回', '周末和法定节假日不计算收益', '高风险！');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `rc_privilege` VALUES (6, '1213374096520249344', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '1213660372964212736', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '1213660455277428736', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894752734459199488', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '893287144657780736', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '893288715881807872', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '893304960282787840', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894396523532517376', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894473486712438784', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894473651837992960', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894477851082883072', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894477995903811584', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '1213374096520249344', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '1213660372964212736', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '1213660455277428736', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (6, '894752734459199488', '2020-01-05 11:24:01');
INSERT INTO `rc_privilege` VALUES (21, '1213374096520249344', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1236582358073737216', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '894752734459199488', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213374096520249344', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1236582358073737216', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '894752734459199488', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213660774094864384', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213660987069038592', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213374096520249344', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1236582358073737216', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '894752734459199488', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213660774094864384', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213660987069038592', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213661249364033536', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1213661353022062592', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (21, '1236598206414979072', '2020-03-08 21:53:13');
INSERT INTO `rc_privilege` VALUES (8, '1213374096520249344', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1236582358073737216', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894752734459199488', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213660774094864384', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213660987069038592', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213661249364033536', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213661353022062592', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1236598206414979072', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213661614847295488', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213662008562417664', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1213662217036103680', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1236603227487600640', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '1241702486889201664', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '893287144657780736', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '893288715881807872', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '893304960282787840', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894396523532517376', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894473486712438784', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894473651837992960', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894475142061621248', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894475827880656896', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894475985452269568', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894476118730473472', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894476276402749440', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894476950951690240', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894477107919323136', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894477244926263296', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894477420512411648', '2020-03-22 20:25:30');
INSERT INTO `rc_privilege` VALUES (8, '894477995903811584', '2020-03-22 20:25:30');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `rc_role` VALUES (6, '管理员', 'admin', NULL, '2017-06-20 15:07:13', '2020-03-08 21:52:09', 1);
INSERT INTO `rc_role` VALUES (8, '超级管理员', 'super', NULL, '2017-06-20 15:08:45', NULL, 1);
INSERT INTO `rc_role` VALUES (21, '普通用户', 'user2', NULL, '2020-03-08 21:52:37', NULL, 1);
COMMIT;
...
INSERT INTO `rc_user` VALUES (59, NULL, 'rain', 'f6f53f28580610d5fba54b502730599d', '1b1c7', 'rain', NULL, 1, NULL, NULL, 1, '2020-03-08 21:01:47', NULL);
INSERT INTO `rc_user` VALUES (60, NULL, 'test', 'ddbe8ee2637ef558118d11f62c6ec154', 'gxom8', '123', NULL, 1, NULL, NULL, 1, '2020-03-08 21:09:47', '2020-03-08 21:55:07');
COMMIT;
...
INSERT INTO `rc_user_role` VALUES (27, 58, 18, '2020-01-31 11:47:26', '管理员');
INSERT INTO `rc_user_role` VALUES (28, 58, 19, '2020-01-31 11:47:26', '管理员');
INSERT INTO `rc_user_role` VALUES (29, 50, 18, '2020-01-31 12:02:21', '管理员');
INSERT INTO `rc_user_role` VALUES (30, 50, 19, '2020-01-31 12:02:21', '管理员');
INSERT INTO `rc_user_role` VALUES (33, 49, 18, '2020-01-31 12:08:10', '管理员');
INSERT INTO `rc_user_role` VALUES (34, 60, 21, '2020-03-08 21:54:59', '管理员');
INSERT INTO `rc_user_role` VALUES (35, 48, 8, '2020-03-22 20:25:43', '管理员');
COMMIT;
