        ...
        <form id="securityEditForm">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="${bean.scard!}"  name="scard" required="required" id="scard" placeholder="">
                </div>
                <div class="form-group">
                    <label id="passwordLabel">剩余贷款总额</label>
                    <input type="text" class="form-control" value="${bean.sbalance!}"  name="sbalance" required="required" id="sbalance" placeholder="">
                </div>
                <div class="form-group">
                    <label id="passwordLabel">每期还款</label>
                    <input type="text" class="form-control" value="${bean.month!}"  name="month" required="required" id="month" placeholder="">
                </div>
