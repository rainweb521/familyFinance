    ...
    <div class="demo">
        ...
        <div class="app">
            <div class="app__bot">
                ...
                <form class="app__meetings reg__form" action="/register">
                    <div class="app__meeting">
                        <div class="glyphicon glyphicon-user"></div>
                        <div class="reg__enter">
                            <input type="text" name="username" class="username" placeholder="昵称"/>
                        </div>
                    </div>
                    <div class="app__meeting">
                    ...
                    <div class="app__meeting">
                        ...
                        <div class="reg__enter">
                            <input type="password" name="password" class="name" placeholder="密码"/>
                        </div>
                    </div>
                    <div class="app__meeting">
                    ...
                    <div class="text-center">
                        <button type="submit" class="login__submit">注册</button>
                    </div>
                </form>
            </div>
